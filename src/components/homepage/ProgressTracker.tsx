  ...
  return (
    <div className={styles.progressTracker}>
      <div className={styles.stepLevel}>
        <div className={styles.step}>
          ...
          <TypographyBodyConfig>
            ...
            helping to highlight and prioritise the most urgent requests
            -bringing awareness and support to the very front-lines, where
            relief is needed the most.
          </TypographyBodyConfig>
        </div>
        <div
      ...
      <div className={styles.stepLevel}>
        ...
        >
          <TypographyStepNumberConfig>2</TypographyStepNumberConfig>
          <div className={styles.verticalBarRel}></div>
        </div>
        <div className={styles.step}>
          ...
          <TypographyBodyConfig>
            Onbording suppliers to meet requests while implementing
            verifications to help ensure standards and requirements are met,
            working to eliminate black market and sub-standard protection that
      ...
      <div className={styles.stepLevel}>
        <div className={styles.step}>
          ...
          <TypographyBodyConfig>
            Enabling &apos;Needs & Leads&apos; to get essentials supplies
            moving- maximising speed efficiency and effectiveness to amplify
            limited supplies manpower and budget resources.
          </TypographyBodyConfig>
        </div>
        <div
          className={styles.step}
        ...
        >
          <TypographyStepNumberConfig>3</TypographyStepNumberConfig>
        </div>
        <div className={styles.step}></div>
      </div>
    </div>
