      ...
      return (
        <div>
          ...
          <div className={styles.needs}>
            <div>
              Quantity needed :{" "}
              <span className={styles.span}>[{needs[0].quantity}]</span>
            </div>
            <div>
              Urgency level:{" "}
              <span className={styles.span}>[{needs[0].urgencyLevel}]</span>
            </div>
            <div>
              Supply posted on:{" "}
              <span className={styles.span}> [{needs[0].createdAt}]</span>
            </div>
            <div>
              Product Specifications (including required certifications such as
              CE, FDA):
              <div className={styles.textarea}>{needs[0].specifications}</div>
            </div>
            {/* <div>
            ...
            <div>
              My budget per piece is :{" "}
              <span className={styles.span}> {needs[0].budget}</span>
              {needs[0].budget}USD
            </div>
            <div>
              My budget per piece is :
              <span className={styles.span}> {needs[0].budget}</span> USD
